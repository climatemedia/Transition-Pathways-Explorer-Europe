<template>
  ...
  <div id="lever-info">
    <div id="lever-info-header">
      <h3 id="lever-info-title">Product manufacturing</h3>
    </div>
    <div id="lever-info-content">
      <p>This lever sets the import of products and the impact of trade.</p>
      <component class="lever-info-chart" v-if="componentInstance" :is="componentInstance"
        chart-title="Product manufacturing" chartfilename="lever_product-net-import.js"
      ></component>
...
export default {
  ...
  methods: {
    loadChartComponent() {
      let fileName = 'lever_product-net-importChart.vue';
